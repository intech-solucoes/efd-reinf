...
import { Botao, CampoTexto, Combo, Box, Col, Row, PainelErros } from '../../components';
...
export default class Campos extends Component {
    ...
    alternarCampos = async () => {
        ...
        switch(this.props.opcaoSelecionada) {
            case 'r1000':
                result = await DominioService.BuscarPorCodigo("DMN_OPER_REGISTRO");
                this.combos.tipoOperacao = result.data;
                await this.handleVisibilidade(["tipoOperacao", "contribuinte", "usuarioResponsavel"]);
                break;

            case 'r1070':
                await this.handleVisibilidade([]);
                break;

            case 'r2010':
                result = await DominioService.BuscarPorCodigo("DMN_EFD_RETIFICADORA");
                this.combos.tipoOperacao = result.data;
                await this.handleVisibilidade(["tipoOperacao", "data"]);
                break;
            ...
            case 'r2098':
                ...
                await this.handleVisibilidade(["referencia", "referenciaAno"]);
                break;
            ...
            case 'r2099':
                ...
                await this.carregaReferencia();               
                await this.handleVisibilidade(["referencia", "referenciaAno", "contratacaoServicos", "prestacaoServicos", 
            ...
            <Box>
                {this.state.visibilidade.tipoOperacao &&
                    <Combo contexto={this} label={"Tipo de operação"} ref={ (input) => this.listaCampos[0] = input } 
                        ...
                        opcoes={this.state.combos.tipoOperacao} />
                }
                ...
                {this.state.visibilidade.contratacaoServicos &&
                    <Combo contexto={this} ref={ (input) => this.listaCampos[7] = input } labelCol="col-lg-4"
                        ...
                        opcoes={this.state.combos.dominioSimNao} />
                }
